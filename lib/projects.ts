...
export const projects: Project[] = [
  ...
  },
  {
    ...
    stack: ["Partnership development", "Contract negotiation", "Visibility management"],
    body: [
      { h: "Challenge", p: "We manage and represent talent across diverse industries, delivering tailored solutions that support brand development, strategic positioning, and long-term growth. Our services span partnership development, contract negotiation, and visibility management across media and digital platforms." },
