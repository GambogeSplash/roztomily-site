...
const PROJECTS: Record<string, Project> = {
  ...
  "morning-fresh-30-million-gang": {
    tag: "PR & Brand Marketing",
    client: "Morning Fresh",
    title: "30 Million Gang Campaign",
    subtitle: "PR and amplification programme for Morning Fresh's three-decade consumer reward campaign under PZ Cussons.",
    duration: "3 min read",
    date: "2022",
    cover: "/roztomily/projects/morning-fresh-30-million-gang/01.jpg",
    role: "PR & amplification lead",
    stack: ["Earned media", "Consumer reward", "Brand love"],
    body: [
      { h: "Challenge", p: "To celebrate three decades in Nigerian households, Morning Fresh under PZ Cussons launched the 30 Million Gang Campaign to reward loyal consumers and reinforce its position as a trusted household brand. The campaign required nationwide visibility, strong consumer participation, and emotionally resonant storytelling across multiple touchpoints." },
      { h: "Approach", p: "We led PR and campaign amplification efforts, with a focus on maximising visibility and strengthening the brand's reputation as one that genuinely values and rewards its consumers." },
      { h: "Outcomes", p: "Significant increase in national awareness for the campaign. High consumer participation driven by reward-based engagement. Strong reinforcement of brand loyalty across key audiences. Consistent media and digital conversations throughout campaign duration. Strengthened perception of Morning Fresh as a rewarding household brand." },
    ],
  },
  "bet9ja-reputation-management": {
    ...
    subtitle: "Crisis communications response to the April 2022 cyberattack and platform shutdown.",
    duration: "3 min read",
    date: "April 2022",
    cover: "/roztomily/projects/bet9ja-reputation-management/01.jpg",
    role: "Crisis communications lead",
    stack: ["Crisis comms", "Stakeholder messaging", "Narrative alignment"],
    body: [
      { h: "Challenge", p: "On 6 April 2022, Bet9ja experienced a cyberattack that resulted in a temporary shutdown of its platform, triggering widespread conversation across social media, news platforms, and stakeholder channels." },
      { h: "Approach", p: "In response to the developing situation, a crisis communication framework was implemented to manage public perception, stabilise stakeholder confidence, and guide consistent messaging during the disruption." },
      { h: "Outcomes", p: "Stabilised brand communication during a high-risk reputational crisis. Maintained stakeholder trust through structured and transparent messaging. Helped reduce potential customer attrition during downtime. Achieved controlled media amplification and narrative alignment." },
    ],
  },
  "bb-irish-mixers-club": {
    tag: "Experiential Marketing",
    client: "Bord Bia",
    title: "Irish Mixers Club",
    subtitle: "Annual mixology competition delivered across five editions to promote Irish drinks in the Nigerian market.",
    duration: "4 min read",
    date: "2019–2024",
    cover: "/roztomily/projects/bb-irish-mixers-club/01.jpg",
    role: "Programme lead",
    stack: ["Competition design", "Industry engagement", "Earned media"],
    body: [
      { h: "Challenge", p: "Bord Bia's Irish Mixers Club was created as an annual mixology competition in Nigeria to promote Irish drinks and celebrate St. Patrick's Day through industry engagement." },
      { h: "Approach", p: "Over five editions, the programme has been delivered as a fully integrated experience covering campaign rollout, participant engagement, grand finale management, and media amplification." },
      { h: "Outcomes", p: "Increased visibility for Irish drinks in the Nigerian market. Successful execution of five consecutive editions of the competition. Strong engagement from bartenders and mixologists nationwide. Consistent media coverage across all editions. Built an active and recurring community around the campaign." },
    ],
  },
...
const GALLERY: Record<string, string[]> = {
  ...
  "morning-fresh-30-million-gang":    ["/roztomily/projects/morning-fresh-30-million-gang/01.jpg",    "/roztomily/projects/morning-fresh-30-million-gang/02.jpg"],
  "bet9ja-reputation-management":     ["/roztomily/projects/bet9ja-reputation-management/01.jpg",    "/roztomily/projects/bet9ja-reputation-management/02.jpg"],
  "bb-irish-mixers-club":             ["/roztomily/projects/bb-irish-mixers-club/01.jpg",            "/roztomily/projects/bb-irish-mixers-club/02.jpg",            "/roztomily/projects/bb-irish-mixers-club/03.jpg"],
